...
/**
 * You can define a visitor that allows you to access a certain type of {@link EnhancedMap} in the stack and call its
 * methods. This way you can for example add properties from a url or add observables after the stack of properties is
 * defined.
 *
 * @param <E>
